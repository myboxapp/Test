...
public class ResourceFinderService {
     ...
     */
    public final DataSet findAvailableCateringResourcesForRoom(
     ...
     * @return list of resources (dataSet to be displayed in grid)
     */
    public final DataSet findAvailableReservableResourcesForRoom(
            final Map<String, String> locationFilter, final DataRecord reservation,
            final DataRecord roomAllocation) {
        ...
        return this.resourceFinderServiceHelper.findAvailableReservableResources(locationFilter.get(BL_ID),
 roomReservation, this.roomReservationDataSource);
    }
     ...
     * @return the data set
     */
    public final DataSet findAvailableCateringResources(final Map<String, String> locationFilter,
        ...
        final ResourceReservation resourceReservation =
                (ResourceReservation) this.resourceReservationDataSource
                    .convertRecordToObject(reservation);
        
        final String buildingId = locationFilter.get(BL_ID);
        resourceReservation.setBuildingId(buildingId);
     ...
     * @return list of resources (dataSet to be displayed in grid)
     */
    public final DataSet findAvailableReservableResources(final Map<String, String> locationFilter,
            final DataRecord reservation) {
        ...
        return this.resourceFinderServiceHelper.findAvailableReservableResources(buildingId,
            resourceReservation, resourceReservationDataSource);
    }
