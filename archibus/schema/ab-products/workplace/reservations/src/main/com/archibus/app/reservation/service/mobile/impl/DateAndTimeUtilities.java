...
public class DateAndTimeUtilities {
     ...
     */
    protected TimePeriod createTimePeriod(final Map<String, String> requestParameters) {
        ...
        Time endTime;
        try {
            dayStart = createDate(requestParameters.get(DAY_START));
            startTime = createTime(requestParameters.get(TIME_START));
            endTime = createTime(requestParameters.get(TIME_END));
