 ...
 */
public abstract class AbstractReservationDataSource<T extends AbstractReservation> extends
        ObjectDataSourceImpl<T> implements IReservationDataSource<T> {
     ...
     * {@inheritDoc}
     */
    public T convertRecordToObject(final DataRecord reservationRecord,
            final List<DataRecord> resourceAllocationRecords) {
        final T reservation = this.convertRecordToObject(reservationRecord);
    ...
    public void cancel(final T reservation) throws ReservationException {
        ...
        final List<ResourceAllocation> activeResourceAllocations =
                reservation.getActiveResourceAllocations();
     ...
     */
    public void addResourceList(final T reservation,
            final DataSetList resourceList) {
        ...
        for (final DataRecord record : resourceList.getRecords()) {
            ...
            reservation.addResourceAllocation(this.resourceAllocationDataSource
     ...
     */
    protected List<T> findActiveReservations(final ParsedRestrictionDef restriction) {
    ...
    /** {@inheritDoc} */
    public List<T> getByParentId(final Integer parentId, final String timeZoneId,
            final Date startDate) {
        return this.getByParentId(parentId, timeZoneId, startDate, null);
    }
    ...
    protected final List<T> getActiveReservationsByParentId(final Integer parentId,
        ...
        return findActiveReservations(restriction);
    }
