...
final class DataSourceUtilities {
    ...
    static DataRecord createRoomReservation(final Map<String, String> requestParameters) {
        ...
        try {
            ...
            reservation.setValue(tableDot + EMAIL, requestParameters.get(EMAIL));
            reservation.setValue(tableDot + PHONE, requestParameters.get(PHONE));
            ...
            reservation.setValue(tableDot + DV_ID, requestParameters.get(DV_ID));
            reservation.setValue(tableDot + DP_ID, requestParameters.get(DP_ID));
